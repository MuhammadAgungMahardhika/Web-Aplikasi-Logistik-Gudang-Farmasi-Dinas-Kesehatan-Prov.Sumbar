...
JOIN sumber
on sumber.id_sumber = barang_masuk.id_sumber
...
no_stock_masuk LIKE '$cari'OR
no_batch LIKE '$cari'OR
tanggal_masuk LIKE '$cari'OR
pengirim LIKE '$cari'OR
sumber LIKE '$cari'OR
ket_masuk LIKE '$cari' OR
jenis_barang LIKE '$cari'OR
pemasukan LIKE '$cari'OR
tanggal_daluwarsa LIKE '$cari'
";
...
if (isset($_GET['menukategori'])) {
  ...
  if ($bulan=='null' && $tahun=='null' && $sumber =='null') {
    $query = "SELECT *FROM barang_masuk 
JOIN barang 
on barang.id_barang = barang_masuk.id_barang
JOIN jenis_barang 
...
on sumber.id_sumber = barang_masuk.id_sumber
";
  }else if ($tahun && $bulan=='null' && $sumber =='null') {
    $query = "SELECT *FROM barang_masuk 
JOIN barang 
on barang.id_barang = barang_masuk.id_barang
JOIN jenis_barang 
...
WHERE year(tanggal_masuk)='$tahun' ";
  ...
  }else if ($bulan && $tahun=='null' && $sumber == 'null') {
...
WHERE month(tanggal_masuk)='$bulan'";
  }else if ($bulan=='null' && $tahun=='null' && $sumber) { 
   $query = "SELECT *FROM barang_masuk 
JOIN barang 
on barang.id_barang = barang_masuk.id_barang
JOIN jenis_barang 
...
on sumber.id_sumber = barang_masuk.id_sumber
WHERE sumber ='$sumber'";
  }else if ($bulan && $tahun && $sumber =='null') {
   $query = "SELECT *FROM barang_masuk 
JOIN barang 
on barang.id_barang = barang_masuk.id_barang
JOIN jenis_barang 
...
WHERE month(tanggal_masuk)='$bulan' AND year(tanggal_masuk)='$tahun' ";
  }else if ($bulan && $tahun=='null' && $sumber) {
   $query = "SELECT *FROM barang_masuk 
JOIN barang 
on barang.id_barang = barang_masuk.id_barang
JOIN jenis_barang 
...
JOIN sumber
on sumber.id_sumber = barang_masuk.id_sumber
WHERE month(tanggal_masuk)='$bulan' AND sumber='$sumber' ";
  }else if ($bulan=='null' && $tahun && $sumber) {
   $query = "SELECT *FROM barang_masuk 
JOIN barang 
on barang.id_barang = barang_masuk.id_barang
JOIN jenis_barang 
...
JOIN sumber
on sumber.id_sumber = barang_masuk.id_sumber
WHERE year(tanggal_masuk)='$tahun' AND sumber='$sumber' ";
  }else if ($bulan && $tahun && $sumber) {
   $query = "SELECT *FROM barang_masuk 
JOIN barang 
on barang.id_barang = barang_masuk.id_barang
JOIN jenis_barang 
...
JOIN sumber
on sumber.id_sumber = barang_masuk.id_sumber
WHERE year(tanggal_masuk)='$tahun' AND sumber='$sumber' AND
                           ...
                           <!-- awal data barang -->
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link " href="obat.php"><i class="fas fa-box-open mr-2"> </i> Data Barang</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-family: 'roboto';">
                                        <thead>
                                          <tr>
                                            <th colspan="10" class="text-center">LAPORAN BARANG MASUK</th>
                                          </tr>
                                          <tr>
                                        ...
                                        <tbody>
                                              ...
                                              $no_stock_masuk = $row['no_stock_masuk'];
