...
ORDER BY barang_keluar.tanggal_keluar DESC LIMIT 100";
...
JOIN barang 
on barang.id_barang = detail_barang_keluar.id_barang
JOIN jenis_barang
on jenis_barang.id_jenis_barang = barang.id_jenis_barang
JOIN satuan 
on satuan.id_satuan = detail_barang_keluar.id_satuan
JOIN sumber
on sumber.id_sumber = detail_barang_keluar.id_sumber
...
WHERE year(tanggal_keluar)='$tahun' ";
   ...
   $query = "SELECT *FROM barang_keluar 
WHERE month(tanggal_keluar)='$bulan'";
  }else if ($bulan && $tahun ) {
   $query = "SELECT *FROM barang_keluar 
WHERE year(tanggal_keluar)='$tahun'  AND
month(tanggal_keluar)='$bulan' ";
  }
                            ...
                            <div class="card-header">
                                 ...
                                 <!-- Button to Open the Modal -->
                                  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal" title="Tambah Data Barang Baru">
                                   <i class="fas fa-plus-square fa-lg"></i>  Barang Keluar 
                                  </button>
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="input-group mb-3">
                                              <span class="input-group-text" style="width: 9rem;">No keluar</span>
                                               ...
                                               <input type="text" name="id_keluar" id="no_batch"  class="form-control" autocomplete="off" required>
                                            </div>

                                            <div class="input-group mb-3">
                                                  <span class="input-group-text" style="width: 9rem;">Tanggal keluar</span>
                                                  <input type="date" name="tanggal_keluar" id="tanggal_keluar" value="<?= date('Y-m-d'); ?>" class="form-control" autocomplete="off" required> 
                                            </div>

                                            <div class="input-group mb-3">
                                              <span class="input-group-text" style="width: 9rem;">Penerima</span>

                                               <input type="text" name="penerima" id="pengirim"  class="form-control" required>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                              ...
                                              <button type="submit" id="doubleclick" name="barangkeluar" class="btn btn-primary ">Masukan</button>
                                            </div>
                               ...
                               <!-- Awal cari kategori-->
                                   <form action="" method="GET" class="form-inline mt-2 mb-2">
                                     <select name="bulan" class="form-control mr-1">
                                      ...
                                      <option value="null">Pilih Bulan Keluar</option>
                                      ...
                                      <select name="tahun" class="form-control mr-1">
                                        <option value="null">Pilih Tahun Keluar</option>
                                        <?= pilih_tahun_keluar(); ?>
                                       </select>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-family: 'roboto';">
                                        ...
                                        <tbody>
                                               ...
                                               <!--  -->
                                                ...
                                                <tr>
                                                 ...
                                                 <td class="text-center">
                                                  ...
                                                  <button type="button"  class="fa fa-edit mr-3" style="color: #6bb4ff;" data-toggle="modal" data-target="#edit<?=$no_stock_keluar;?>" title="Edit"></button>

                                                  <a  href="detail_barang_keluar.php?id_keluar=<?=$no_stock_keluar; ?>" title="Detail" style="text-decoration: none;" class=" mr-3"><i class="fa fa-eye " style="color: #32CD32;" ></i> </a>

                                                   <button type="button" class="fa fa-trash" style="color: #e60003;" data-toggle="modal" data-target="#hapus<?=$no_stock_keluar;?>" title="Hapus "></button>
                                         ...
                                         <!-- awal edit modal -->
                                            <div class="modal fade" id="edit<?=$no_stock_keluar ?>">
                                                    ...
                                                    <div class="modal-dialog">
                                                      <div class="modal-content">
                                                        ...
                                                        <!-- Modal Header -->
                                                        <div class="modal-header">
                                                          <h4 class="modal-title">Edit no keluar <?= $no_stock_keluar; ?></h4>
                                                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          <div class="input-group mb-3">
                                                            <span class="input-group-text " style="width: 9rem;">Tanggal keluar</span>
                                                            <input type="date" name="tanggal_keluar"  value="<?= $tanggal_keluar?>" class="form-control" autocomplete="off" required> 
                                                          </div>

                                                          <div class="input-group mb-3">
                                                            <span class="input-group-text " style="width: 9rem;">Penerima</span>
                                                            <input type="text" name="penerima"  value="<?= $penerima ?>" class="form-control" autocomplete="off" required> 
                                                          </div>
                                                        ...
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                          <button type="submit" name="editbarangkeluar" class="btn btn-primary">Edit barang masuk</button>
                                                        </div>
                                                         </form>
                                              ...
                                              <!-- awal hapus modal -->
                                                <div class="modal fade" id="hapus<?=$no_stock_keluar;?>">
                                                      ...
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          Apakah anda yakin ingin menghapus barang masuk dengan no <?= $no_stock_keluar ?> ? 
                                                          <br>
                                                        ...
                                                        <div class="modal-footer">
                                                          ...
                                                          <p style="color: red; font-size: 13px;">*Note : Jika barang keluar dihapus, maka semua data barang didalamnya juga ikut terhapus </p>
