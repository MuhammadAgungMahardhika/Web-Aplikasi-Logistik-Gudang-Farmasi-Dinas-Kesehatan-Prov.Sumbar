                            ...
                            <div class="card-header">
                                 ...
                                 <!-- Button to Open the Modal -->
                                   ...
                                   <div class="dropdown">
                                    ...
                                    <button type="button" class="btn btn-success"  data-toggle="modal" data-target="#myModal" title="Tambah Sumber Baru">
                                    <i class="fas fa-plus-square fa-lg"></i> Tambah Sumber 
                                    </button>
                                        ...
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                              <h4 class="modal-title text-center">Tambah Sumber Barang </h4>
                                            ...
                                            <div class="modal-body">
                                              ...
                                              <input type="text" name="sumber" id="nama_barang" placeholder="Sumber baru" class="form-control" required autocomplete="off">
                                            ...
                                            <div class="modal-footer">
                                              <button type="submit" id="doubleclick" name="tambahsumberbarang" class="btn btn-primary ">Masukan</button>
                                            </div>
                                          ...
                                          <tr>
                                            ...
                                            <tbody>
                                             ...
                                             $sumber =$row['sumber'];
                                              ...
                                              $jumlah_barang = mysqli_query($conn,"SELECT id_sumber FROM detail_barang_masuk WHERE detail_barang_masuk.id_sumber = '$id_sumber' ");
                                               ?>
                                               ...
                                               <!--  -->
                                                <tr>
                                                  ...
                                                  <button type="button"  class="fa fa-edit mr-3" style="color: #6bb4ff;" data-toggle="modal" data-target="#edit<?=$id_sumber;?>" title="Edit"></button>

                                                  <button type="button" class="fa fa-trash" style="color: #e60003;" data-toggle="modal" data-target="#hapus<?=$id_sumber;?>" title="Hapus "></button>
                                                 ...
                                                 <!-- awal edit modal -->
                                                <div class="modal fade" id="edit<?=$id_sumber;?>">
                                                    ...
                                                    <div class="modal-dialog">
                                                      <div class="modal-content">
                                                        ...
                                                        <!-- Modal Header -->
                                                        <div class="modal-header">
                                                          <h4 class="modal-title">Edit Sumber Anggaran</h4>
                                                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          <input type="hidden" name="id_sumber" value="<?= $id_sumber?>" class="form-control" autocomplete="off">
                                                      
                                                          <input type="text" name="sumber" value="<?= $sumber ?>" class="form-control" autocomplete="off" required>
                                                          
                                                        
                                                        </div>
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                          <button type="submit" name="editsumberbarang" class="btn btn-primary">Masukan</button>
                                                        </div>
                                                         </form>
                                              ...
                                              <!-- akhir edit modal -->
                                               ...
                                               <!-- awal hapus modal -->
                                                <div class="modal fade" id="hapus<?=$id_sumber;?>">
                                                      ...
                                                      <div class="modal-content">
                                                        ...
                                                        <!-- Modal Header -->
                                                        <div class="modal-header">
                                                          <h4 class="modal-title">Hapus sumber anggaran</h4>
                                                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          Apakah anda yakin ingin menghapus sumber <?= $sumber ?> ? 
                                                          <br>
                                                        ...
                                                        <div class="modal-footer">
                                                          ...
                                                          <p style="color: red; font-size: 13px;">*Note : Jika sumber anggaran ini dihapus, semua barang yang memiliki sumber anggaran ini juga ikut terhapus</p>
                                                          <button type="submit" name="hapussumberbarang" class="btn btn-danger">Hapus</button>
                                                        </div>
                                                         </form>
                                                        </div>
