                            ...
                            <div class="card-header">
                                 ...
                                 <!-- Button to Open the Modal -->
                                   ...
                                   <div class="dropdown">
                                    ...
                                    <button type="button" class="btn btn-success"  data-toggle="modal" data-target="#myModal" title="Tambah Satuan Baru">
                                    <i class="fas fa-plus-square fa-lg"></i> Tambah Satuan
                                    </button>
                                        ...
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                              <h4 class="modal-title text-center">Tambah Satuan Barang </h4>
                                            ...
                                            <div class="modal-body">
                                              ...
                                              <input type="text" name="satuan" id="nama_barang" placeholder="Satuan baru" class="form-control" required autocomplete="off">
                                            ...
                                            <div class="modal-footer">
                                              <button type="submit" id="doubleclick" name="tambahsatuanbarang" class="btn btn-primary ">Masukan</button>
                                            </div>
                                             ...
                                             $satuan =$row['satuan'];
                                               ...
                                               <!--  -->
                                                <tr>
                                                  ...
                                                  <button type="button"  class="fa fa-edit mr-3" style="color: #6bb4ff;" data-toggle="modal" data-target="#edit<?=$id_satuan;?>" title="Edit"></button>

                                                  <button type="button" class="fa fa-trash" style="color: #e60003;" data-toggle="modal" data-target="#hapus<?=$id_satuan;?>" title="Hapus "></button>
                                                    ...
                                                    <div class="modal-dialog">
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          <input type="hidden" name="id_satuan" value="<?= $id_satuan?>" class="form-control" autocomplete="off">
                                                      
                                                          <input type="text" name="satuan" value="<?= $satuan ?>" class="form-control" autocomplete="off" required>
                                                          
                                                        
                                                        </div>
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                          <button type="submit" name="editsatuanbarang" class="btn btn-primary">Masukan</button>
                                                        </div>
                                                         </form>
                                              ...
                                              <!-- akhir edit modal -->
                                               ...
                                               <!-- awal hapus modal -->
                                                <div class="modal fade" id="hapus<?=$id_satuan;?>">
                                                      ...
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          Apakah anda yakin ingin menghapus satuan <?= $satuan ?> ? 
                                                          <br>
                                                        ...
                                                        <div class="modal-footer">
                                                          ...
                                                          <p style="color: red; font-size: 13px;">*Note : Jika satuan barang ini dihapus, semua barang yang memiliki satuan barang ini juga ikut terhapus</p>
                                                          <button type="submit" name="hapussatuanbarang" class="btn btn-danger">Hapus</button>
                                                        </div>
                                                         </form>
                                                        </div>
