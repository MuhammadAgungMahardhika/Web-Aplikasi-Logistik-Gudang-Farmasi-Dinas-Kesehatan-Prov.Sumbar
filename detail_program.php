...
JOIN detail_program
on detail_program.id_barang = barang.id_barang
WHERE detail_program.id_program = '$id_program' ";
                                ...
                                <!-- awal Laporan barang -->
                                 ...
                                 <div class="sb-sidenav-menu-heading">Laporan</div>
                                    ...
                                    <div class="collapse" id="collapseLayouts4" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                        <nav class="sb-sidenav-menu-nested nav">
                                           <a class="nav-link " href="laporan_barang.php"><i class="fas fa-layer-group mr-1"></i> Laporan barang</a>
                                           <a class="nav-link " href="laporan_barang_masuk.php"><i class="fas fa-layer-group mr-1"></i> Laporan barang masuk</a>
                                           <a class="nav-link " href="laporan_barang_keluar.php"><i class="fas fa-layer-group mr-1"></i> Laporan barang keluar</a>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="program.php">Program</a></li>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                               <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                                        <thead>
                                          <?php $ju = mysqli_query($conn,"SELECT * FROM program WHERE id_program='$id_program' ");

                                          $ji = mysqli_fetch_assoc($ju); 
                                          $program = $ji['program']; ?>
                                          <tr>
                                            <th colspan="3" class="text-center"><?=$program; ?></th>
                                          </tr>
                                          <tr>
                                            <th >No </th>
                                                ...
                                                <div class="modal fade" id="hapus<?=$id_barang;?>">
                                                      ...
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                          <h4 class="modal-title">Hapus <?=$nama_barang ?> dari program ini ?</h4>
                                                        ...
                                                        <div class="modal-body">
                                                           ...
                                                           <input type="hidden" name="id_barang" value="<?= $id_barang?>" class="form-control"  >
                                                            ...
                                                            <input type="hidden" name="id_program" value="<?= $id_program?>" class="form-control"  >

                                                          Apakah anda yakin ingin menghapus <?= $nama_barang ?> dari program ini? 
                                                          
                                                        </div>
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">

                                                          <button type="submit" name="hapusbarangprogram" class="btn btn-danger">Hapus</button>
                                                        </div>
                                                         </form>
                                                        </div>
                                   ...
                                   <div class="modal fade" id="myModal">
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            ...
                                            <!-- Modal Header -->
                                            <div class="modal-header">
                                              <h4 class="modal-title text-center">Tambah barang </h4>
                                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            </div>
                                            ...
                                            <div class="modal-body">
                                              ...
                                              <select name="id_barang" class="form-control">
                                               <?php 
                                                ...
                                                $query_bar = "SELECT * from barang  ORDER BY nama_barang ASC";
                                            ...
                                            <!-- Modal footer -->
                                            <div class="modal-footer">
                                              <button type="submit" id="doubleclick" name="tambahbarangprogram" class="btn btn-primary ">Masukan</button>
                                            </div>
