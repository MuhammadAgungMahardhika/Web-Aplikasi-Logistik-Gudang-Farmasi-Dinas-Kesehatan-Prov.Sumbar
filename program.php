    ...
    <!-- awal transaksi -->
                            ...
                            <div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link " href="jenis_barang.php"><i class="fas fa-layer-group mr-1"></i> Jenis Barang</a>
                                    <a class="nav-link " href="sumber.php"><i class="fas fa-comment-dollar mr-1"></i> Sumber </a>
                                    <a class="nav-link " href="satuan.php"><i class="fab fa-unity mr-1"></i> Satuan Barang</a>

                                    <a class="nav-link " href="program.php"><i class="fas fa-address-book mr-1"> </i></i> Program </a>
                            ...
                            <div class="card-header">
                                 ...
                                 <!-- Button to Open the Modal -->
                                   ...
                                   <div class="dropdown">
                                    ...
                                    <button type="button" class="btn btn-success"  data-toggle="modal" data-target="#myModal" title="Tambah program Baru">
                                    <i class="fas fa-plus-square fa-lg"></i> Tambah program 
                                    </button>
                                        ...
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                              <h4 class="modal-title text-center">Tambah program Barang </h4>
                                            ...
                                            <div class="modal-body">
                                              ...
                                              <input type="text" name="program" id="nama_barang" placeholder="program baru" class="form-control" required autocomplete="off">
                                            ...
                                            <div class="modal-footer">
                                              <button type="submit" id="doubleclick" name="tambahprogrambarang" class="btn btn-primary ">Masukan</button>
                                            </div>
                                        ...
                                        <thead>
                                          <tr>
                                            ...
                                            <tbody>
                                             ...
                                             $jumlah_barang = mysqli_query($conn,"SELECT id_program FROM detail_program WHERE id_program = '$id_program' ");
                                               ...
                                               <!--  -->
                                                <tr>
                                                  ...
                                                  <button type="button"  class="fa fa-edit mr-3" style="color: #6bb4ff;" data-toggle="modal" data-target="#edit<?=$id_program;?>" title="Edit"></button>

                                                    <a href="detail_program.php?id_program=<?=$id_program; ?>" style="text-decoration: none;" title="Detail" class="mr-3"><i class="fa fa-eye " style="color: #32CD32;" ></i> </a>


                                                  <button type="button" class="fa fa-trash" style="color: #e60003;" data-toggle="modal" data-target="#hapus<?=$id_program;?>" title="Hapus "></button>
                                                 ...
                                                 <!-- awal edit modal -->
                                                <div class="modal fade" id="edit<?=$id_program;?>">
                                                    ...
                                                    <div class="modal-dialog">
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          <input type="hidden" name="id_program" value="<?= $id_program?>" class="form-control" autocomplete="off">
                                                      
                                                          <input type="text" name="program" value="<?= $program ?>" class="form-control" autocomplete="off" required>
                                                          
                                                        
                                                        </div>
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                          <button type="submit" name="editprogrambarang" class="btn btn-primary">Masukan</button>
                                                        </div>
                                                         </form>
                                              ...
                                              <!-- akhir edit modal -->
                                               ...
                                               <!-- awal hapus modal -->
                                                <div class="modal fade" id="hapus<?=$id_program;?>">
                                                      ...
                                                      <div class="modal-content">
                                                        ...
                                                        <!-- Modal Header -->
                                                        <div class="modal-header">
                                                          <h4 class="modal-title">Hapus Program </h4>
                                                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          Apakah anda yakin ingin menghapus program <?= $program ?> ? 
                                                          <br>
                                                        ...
                                                        <div class="modal-footer">
                                                          ...
                                                          <p style="color: red; font-size: 13px;">*Note : Jika program  ini dihapus, semua barang yang memiliki program  ini juga ikut terhapus</p>
                                                          <button type="submit" name="hapusprogrambarang" class="btn btn-danger">Hapus</button>
                                                        </div>
                                                         </form>
                                                        </div>
