                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="barangkeluar.php">Barang keluar</a></li>
                                            ...
                                            <div class="input-group mb-3">
                                              ...
                                              <select name="id_barang" class="form-control" id="id_barang_js" >
                                               ...
                                               <?php 
                                                ...
                                                $query_bar = "SELECT distinct barang.nama_barang,barang.id_barang FROM barang JOIN detail_barang_masuk on detail_barang_masuk.id_barang = barang.id_barang  
                                         ...
                                         <div class="input-group mb-3">
                                             ...
                                             <div class="input-group mb-3">
                                                 <span class="input-group-text" style="width: 9rem;">Keterangan</span>
                                                   <textarea class="form-control" id="ket_keluar" rows="3"  name="ket_keluar" autocomplete="off"></textarea>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-family: 'roboto';">
                                        ...
                                        <tbody>
                                              ...
                                              $ket_keluar = $row['ket_keluar'];
                                               ...
                                               <!--  -->
                                                ...
                                                <tr>
                                                  ...
                                                  <button type="button"  class="fa fa-edit mr-3" style="color: #6bb4ff;" data-toggle="modal" data-target="#edit<?=$id_barang;?>&&<?=$no_stock_keluar;?>&&<?=$no_stock_masuk; ?>" title="Edit"></button>

                                                   <button type="button" class="fa fa-trash " style="color: #e60003;" data-toggle="modal" data-target="#hapus<?=$id_barang;?>&&<?=$no_stock_keluar;?>&&<?=$no_stock_masuk; ?>" title="Hapus "></button>
                                         ...
                                         <!-- awal edit modal -->
                                            <div class="modal fade" id="edit<?=$id_barang;?>&&<?=$no_stock_keluar ?>&&<?=$no_stock_masuk; ?>">
                                                    ...
                                                    <div class="modal-dialog">
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          <div class="input-group mb-3">
                                                            <span class="input-group-text" style="width: 9rem;">Keterangan</span>
                                                            <input type="textarea" name="ket_keluar" value="<?= $ket_keluar ?>" class="form-control" autocomplete="off" required> 
                                                          </div>
                                    
                                                          </div>
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                          <button type="submit" name="edit_detail_barang_keluar" class="btn btn-primary">Edit barang keluar</button>
                                                        </div>
                                                         </form>
                                              ...
                                              <!-- awal hapus modal -->
                                                <div class="modal fade" id="hapus<?=$id_barang;?>&&<?=$no_stock_keluar; ?>&&<?=$no_stock_masuk; ?>">
                                                      ...
                                                      <div class="modal-content">
                                                        ...
                                                        <!-- Modal Header -->
                                                        <div class="modal-header">
                                                          <h4 class="modal-title">Hapus detail barang keluar</h4>
                                                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          Apakah anda yakin ingin menghapus barang <?= $nama_barang; ?> dari no.keluar <?= $no_stock_keluar; ?> ? 
                                                       
                                                        </div>
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">

                                                          <button type="submit" name="hapusdetailbarangkeluar" class="btn btn-danger">Hapus</button>
                                                        </div>
                                                         </form>
                                                        </div>
           ...
           <script>
              $(document).ready(function(){
                ...
                $('#id_barang_js').on('change',function(){
                  ...
                  $('#id_masuk_js').load('ajax/tambahbarang.php?id_barang='+$('#id_barang_js').val());
